    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              ...
              <h2 class="sub-header">当前共有${airPlanesListLength}条指令</h2>
                ...
                <button type="button" class="btn btn-lg btn-success" onclick="javascript:window.location.href='addAirPlane.jsp';">新增指令</button>
            </div>
            </div>
        </div>
     </div>
