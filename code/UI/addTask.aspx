<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addTask.aspx.cs" Inherits="our.ui.addTask1" %>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <button type="submit" class="btn btn-lg btn-success" runat="server" id="Button1">抓取东西</button>
                <button type="submit" class="btn btn-lg btn-success" runat="server" id="Button2">天气播报</button>
                <br /><br />
                ...
                <select class="selBox" name="name1" id="name1" onchange="check();">
                    <option value="1">起点</option>
                    <option value="2">终点</option>
                </select>
                <button type="submit" class="btn btn-lg btn-success" runat="server" id="Button4">前往导航点</button>
                <br /><br />
                <asp:Label ID="Label2" runat="server" text="" style="font-weight:600">选择移动指令：</asp:Label>
                <select class="selBox" name="name2" id="name2" onchange="check();">
                    <option value="forward">forward</option>
                    <option value="left">left</option>
                    <option value="right">right</option>
                    <option value="back">back</option>
                </select>
                <asp:Label ID="Label3" runat="server" text="" style="font-weight:600">距离：</asp:Label>
                <select class="selBox" name="name3" id="name3" onchange="check();">
                    <option value="1">1m</option>
                    <option value="2">1.5m</option>
                    <option value="3">2m</option>
                    <option value="4">2.5m</option>
                </select>
                <asp:Label ID="Label4" runat="server" text="" style="font-weight:600">角度：</asp:Label>
                <select class="selBox" name="name4" id="name4" onchange="check();">
                    <option value="1">0°</option>
                    <option value="2">30°</option>
                    <option value="3">60°</option>
                </select>
                <button type="submit" class="btn btn-lg btn-success" runat="server" id="Button5">移动</button>
                <br /><br />
                <button type="submit" class="btn btn-lg btn-success" runat="server" id="Button6">语音输入命令</button>
