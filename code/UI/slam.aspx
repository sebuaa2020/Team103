        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <form runat="server" method="post" action="">
                    <button type="submit" class="btn btn-lg btn-success" id="Button1">开始建图</button>
                    <button type="submit" class="btn btn-lg btn-success" id="Button2">保存地图</button>
                    <button type="submit" class="btn btn-lg btn-success" id="Button3">导航点设置</button>
