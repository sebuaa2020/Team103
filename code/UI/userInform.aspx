    ...
    <div class="container">
        ...
        <form class="form-horizontal" role="form">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" id="disabledInput1" type="text" placeholder="1" disabled name="no"/>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-default" style="border-color:aquamarine;background-color:azure">提交</button>
        </form>
    </div>
