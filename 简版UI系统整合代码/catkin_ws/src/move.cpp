...
int main(int argc, char*argv[]) {
	...
	system("touch /home/user/catkin_ws/src/wpb_home/wpb_home_bringup/config/wpb_home1.yaml");
    config_file.open("/home/user/catkin_ws/src/wpb_home/wpb_home_bringup/config/wpb_home1.yaml");
