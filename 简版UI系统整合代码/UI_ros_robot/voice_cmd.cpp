...
string broadCastWeather(){
    system("rm /home/user/catkin_ws/weatherInfo.txt");
    ...
    static char linedata[1024] = {0};
    do{
        weatherInfo.open("/home/user/catkin_ws/weatherInfo.txt");
...
void broadCastAny(char* word){
    ...
    ifstream in;
    in.open("/home/user/catkin_ws/src/my_speak_package/launch/speakany.launch");
    string strFileData = "";
	int line = 1;
	...
	ofstream out;
    out.open("/home/user/catkin_ws/src/my_speak_package/launch/speakany.launch");
	out.flush();
	out<<strFileData;
	out.close();
...
string getVoiceInstr(){
    system("rm /home/user/catkin_ws/keyword.txt");
    system("touch /home/user/catkin_ws/keyword.txt");
    ...
    do{
        cout <<"1"<<endl;
        keyword.open("/home/user/catkin_ws/keyword.txt");
